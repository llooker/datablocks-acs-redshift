view: rs_block_group_facts {
  sql_table_name: public.fast_facts ;;
  ...
  measure: avg_persons_house {
    ...
    sql: 1.0 * ${total_population}/NULLIF(${housing_units}, 0) ;;
  ...
  measure: avg_income_house {
    ...
    sql: 1.0 * ${aggregate_income}/NULLIF(${housing_units}, 0) ;;
  ...
  measure:  pct_male{
    ...
    group_label: "Sex"
    sql: 1.0 * ${male_population}/NULLIF(${total_population}, 0) ;;
  ...
  measure:  pct_female{
    ...
    group_label: "Sex"
    sql: 1.0 * ${female_population}/NULLIF(${total_population}, 0) ;;
    value_format_name: percent_2
  }
  ...
  measure: pct_white {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${white_alone_or_in_combo}/NULLIF(${total_population}, 0) ;;
  }
  measure: pct_black {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${black_alone_or_in_combo}/NULLIF(${total_population}, 0) ;;
  }
  measure: pct_asian {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${asian_alone_or_in_combo}/NULLIF(${total_population}, 0) ;;
  }
  measure: pct_amind {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${amind_alone_or_in_combo}/NULLIF(${total_population}, 0) ;;
  }
  measure: pct_nathaw {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${nat_haw_alone_or_in_combo}/NULLIF(${total_population}, 0) ;;
  }
  measure: pct_white_nh {
    ...
    type: number
    value_format_name: percent_2
    sql: 1.0 * ${white_non_hisp}/NULLIF(${total_population}, 0) ;;
  }
  ...
  measure: pct_hispanic_or_latino {
    ...
    type: number
    sql: 1.0 * ${hispanic_or_latino}/NULLIF(${total_population}, 0) ;;
    group_label: "Hispanic/Latino"
    value_format_name: percent_2
  }
  measure: pct_non_hispanic_or_latino {
    ...
    type: number
    sql: 1-(1.0 * ${hispanic_or_latino}/NULLIF(${total_population}, 0)) ;;
    group_label: "Hispanic/Latino"
    value_format_name: percent_2
  }
  ...
  measure: pct_under_18 {
    ...
    type: number
    sql: 1.0 * ${under_18}/NULLIF(${total_population}, 0) ;;
    group_label: "Age"
    value_format_name: percent_2
  }
  measure: pct_18_64 {
    ...
    type: number
    sql: 1.0 * ${eighteen_to_64}/NULLIF(${total_population}, 0) ;;
    group_label: "Age"
    value_format_name: percent_2
  }
  measure: pct_65_over {
    ...
    type: number
    sql: 1.0 * ${sixty_five_and_over}/NULLIF(${total_population}, 0) ;;
    group_label: "Age"
    value_format_name: percent_2
  }
